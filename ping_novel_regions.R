...
cat('\nCondensing the processed reads into a single structure...')
run.condense_assembly_list(pairedAssemblyUnlistedList, assembledNucList, nucListConv)
run.condense_assembly_list(unpairedAssemblyList, assembledNucList, nucListConv)
cat('\nFinished.')
