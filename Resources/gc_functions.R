...
autoCopy.set_ratios <- function( currentSample, minDP, ratio.df, snpOutput.dir, named.uniquePos.list, lowVar.pos.list ){
  ...
  snpDepth.locusVect <- c('KIR2DL2','KIR2DS1')
  readDepth.locusVect <- c('KIR3DL1','KIR2DL3','KIR2DL4','KIR2DL5','KIR2DS3','KIR2DS4','KIR3DL2','KIR3DP1','KIR3DS1','KIR2DP1','KIR2DS2','KIR2DS5')
