...
setup.hetRatio <- Sys.getenv("HET_RATIO", unset=0.25)
final.hetRatio <- Sys.getenv("HET_RATIO", unset=0.25)
setup.minDP <- Sys.getenv("MIN_DP", unset=8)
final.minDP <- Sys.getenv("MIN_DP", unset=20)
copy.readBoost <- Sys.getenv("SETUP_READBOOST", unset=T)
